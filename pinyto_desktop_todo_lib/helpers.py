...
from . pinyto_desktop_todoconfig import get_data_file
...
def get_builder(builder_file_name):
    ...
    builder = Builder()
    builder.set_translation_domain('pinyto-desktop-todo')
...
def set_up_logging(opts):
    ...
    lib_logger = logging.getLogger('pinyto_desktop_todo_lib')
